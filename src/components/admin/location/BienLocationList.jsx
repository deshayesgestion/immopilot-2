...
import { Pencil, Trash2, Eye, Globe, Globe2 } from "lucide-react";

const STATUS_CONFIG = {
  disponible: { label: "Publié", color: "bg-green-100 text-green-700" },
  loue: { label: "Loué", color: "bg-blue-100 text-blue-700" },
  sous_compromis: { label: "En cours", color: "bg-amber-100 text-amber-700" },
    ...
    <div className="bg-white rounded-2xl border border-border/50 shadow-sm overflow-hidden">
      ...
      <div className="divide-y divide-border/30">
        {biens.map((bien) => {
          ...
          return (
            <div key={bien.id} className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_auto] gap-4 items-center px-5 py-3.5 hover:bg-secondary/20 transition-colors">
              {/* Bien */}
              <div className="min-w-0">
                ...
                <p className="text-xs text-muted-foreground mt-0.5 truncate">
                  ...
                  {bien.agent_email ? ` · ${bien.agent_email}` : ""}
                </p>
              </div>
