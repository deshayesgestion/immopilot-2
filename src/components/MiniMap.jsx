...
export default function MiniMap({ property }) {
  ...
  return (
    <div className="relative rounded-xl overflow-hidden border border-border/50" style={{ height: 200 }}>
      {loading ? (
        ...
        <div className="w-full h-full bg-secondary/40 flex flex-col items-center justify-center gap-1">
          ...
          <span className="text-xs text-muted-foreground/40">Localisation non disponible</span>
        </div>
      ) : (
        <MapContainer
