  ...
  return (
    <div className="pt-24 pb-16 min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        <AnimatedSection>
          <div className="mb-10">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Biens à vendre</h1>
            <p className="mt-2 text-muted-foreground">
              Découvrez notre sélection de biens immobiliers à la vente.
            </p>
          </div>
        </AnimatedSection>

        <AnimatedSection delay={100}>
          <PropertyFilters filters={filters} onFilterChange={setFilters} transaction="vente" />
        </AnimatedSection>
