...
export default function ProprietaireDocuments() {
  ...
  const allDocs = dossiers.flatMap(d => [
    ...(d.contrat_url ? [{ label: "Contrat de bail", url: d.contrat_url, property: d.property_title }] : []),
    ...(d.documents || []).map(doc => ({ ...doc, property: d.property_title })),
  ]);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Tous les documents liés à vos biens</p>
      </div>
            ...
            {allDocs.map((doc, i) => (
              <div key={i} className="flex items-center gap-4 px-5 py-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium">{doc.label || doc.libelle}</p>
